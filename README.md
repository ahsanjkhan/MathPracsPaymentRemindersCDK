...
This is the Infrastructure-as-Code of an AWS Micro Service which processes automated payment text message reminders for students and tutors enrolled in tutoring with MathPracs.
